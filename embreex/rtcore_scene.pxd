...
cdef extern from "embree4/rtcore_scene.h":
    ...
    # Funciones de point query
    bool rtcPointQuery(RTCScene scene, rtc.RTCPointQuery* query, rtc.RTCPointQueryContext* context,
                       rtc.RTCPointQueryFunction queryFunc, void* userPtr)
    bool rtcPointQuery4(const int* valid, RTCScene scene, rtc.RTCPointQuery4* query,
                        rtc.RTCPointQueryContext* context, rtc.RTCPointQueryFunction queryFunc, void** userPtr)
    bool rtcPointQuery8(const int* valid, RTCScene scene, rtc.RTCPointQuery8* query,
                        rtc.RTCPointQueryContext* context, rtc.RTCPointQueryFunction queryFunc, void** userPtr)
    bool rtcPointQuery16(const int* valid, RTCScene scene, rtc.RTCPointQuery16* query,
                         rtc.RTCPointQueryContext* context, rtc.RTCPointQueryFunction queryFunc, void** userPtr)
    ...
    # Collision detection callback and function
